  ...
  return (
    <div className={`flex flex-col gap-1.5 w-full text-left ${className}`}>
      ...
      <input
        ...
        required={required}
        className={`
          w-full px-4 py-2.5 font-sans text-sm text-primary border border-border-light bg-white 
          focus:border-primary focus:ring-2 focus:ring-accent focus:outline-none 
          placeholder:text-secondary/50 transition-all duration-200 rounded-lg shadow-2xs
